<?php
    ...
    $categoria->setDados("'$txt_titulo','','$txt_ordem','$txt_ativo'");
    $categoria->inserir();
    ...
    if($acao=='Alterar'){
        ...
        $categoria->setCampos("categoria = '$txt_titulo' , slug_categoria = ' ' , ordem_categoria = '$txt_ordem' , ativo_categoria = '$txt_ativo' ");
